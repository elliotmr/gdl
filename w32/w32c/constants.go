...
type ShowWindow int32
const (
	SW_HIDE ShowWindow           = 0
	SW_NORMAL         ShowWindow = 1
	SW_SHOWNORMAL     ShowWindow = 1
	SW_SHOWMINIMIZED  ShowWindow = 2
	SW_MAXIMIZE       ShowWindow = 3
	SW_SHOWMAXIMIZED  ShowWindow = 3
	SW_SHOWNOACTIVATE ShowWindow = 4
	SW_SHOW           ShowWindow = 5
	SW_MINIMIZE       ShowWindow = 6
	SW_SHOWMINNOACTIVE ShowWindow= 7
	SW_SHOWNA         ShowWindow = 8
	SW_RESTORE        ShowWindow = 9
	SW_SHOWDEFAULT    ShowWindow = 10
	SW_FORCEMINIMIZE  ShowWindow = 11
)

// Predefined cursor constants
type CursorType uintptr
const (
	IDC_ARROW      CursorType = 32512
	IDC_IBEAM      CursorType = 32513
	IDC_WAIT       CursorType = 32514
	IDC_CROSS      CursorType = 32515
	IDC_UPARROW    CursorType = 32516
	IDC_SIZENWSE   CursorType = 32642
	IDC_SIZENESW   CursorType = 32643
	IDC_SIZEWE     CursorType = 32644
	IDC_SIZENS     CursorType = 32645
	IDC_SIZEALL    CursorType = 32646
	IDC_NO         CursorType = 32648
	IDC_HAND       CursorType = 32649
	IDC_APPSTARTING CursorType = 32650
	IDC_HELP        CursorType = 32651
	IDC_ICON        CursorType = 32641
	IDC_SIZE        CursorType = 32640
)
...
const (
	...
	HWND_BOTTOM    = syscall.Handle(1)
	HWND_NOTOPMOST = ^syscall.Handle(1) // -2
	HWND_TOP       = syscall.Handle(0)
	HWND_TOPMOST   = ^syscall.Handle(0) // -1
	HWND_DESKTOP   = syscall.Handle(0)
	HWND_MESSAGE   = ^syscall.Handle(2) // -3
)
